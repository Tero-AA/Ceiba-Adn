...
describe('Task.repository.mongo', () => {
  ...
  it('should return one task', () => {
    expect(repositoryMongo.getTask('5e39c3384caa9d380437f5cb')).resolves.toEqual(task)
  });
  ...
  it('should delete task', () => {
    expect(repositoryMongo.deleteTask('5e39c3384caa9d380437f5cb')).resolves.toEqual(task)
  });

  it('should update a task', () => {
    expect(repositoryMongo.updateTask('5e39c3384caa9d380437f5cb', task)).resolves.toEqual(task)
  })
})